...
<html lang="fr">
  <head>
    ...
    <title>Cours PHP 2k22 - Fiche employé <?php echo $fiche['id_employes']; ?></title>
  ...
  <div class="row">
    ...
    <div class="col-sm-8 bg-white p-5">
        <div class="row jumbotron bg-light">
            <div class="col-sm-12">
                <h1 class="text-center">Cours PHP 2k22- Employé<?php if($fiche['sexe'] == 'f') {?> e<?php } echo " " .$fiche['prenom']. " " .$fiche['nom']; ?></h1>
